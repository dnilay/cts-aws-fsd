...
public class App {
  ...
  public static void main(String[] args) {
    ...
    weather.timePasses();
		 ...
		 * Wadler LOGGER.info("--Running generic version--"); var genericWeather = new
		 * GWeather(); genericWeather.addObserver(new GOrcs());
		 * genericWeather.addObserver(new GHobbits());
		 * 
		 * genericWeather.timePasses(); genericWeather.timePasses();
		 * genericWeather.timePasses(); genericWeather.timePasses();
		 */
  }
}
